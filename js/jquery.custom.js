...
var fillvisible=false;
	// cart
	$('#topbar_login.not_logged_in a.topbar_login').click(function(e){
		
		$('#fast-login').fadeToggle();
		logvisible=!logvisible;
if(fillvisible){ fillvisible=!fillvisible;
$('#fast-fillform').fadeToggle();
}
    ...
    /* topbar fillform */
	// cart
	$('#topbar_fillform.ff a.topbar_fillform').click(function(e){
		$('#fast-fillform').fadeToggle();
				fillvisible=!fillvisible;
if(logvisible){ logvisible=!logvisible;
$('#fast-login').fadeToggle();
}
		e.preventDefault();
	});
	
	$('#fast-fillform').on( "clickoutside", function(event){
		if( !$(this).is(':animated') && $(this).is(':visible') ) 
			$('#fast-fillform').fadeOut();
	});
